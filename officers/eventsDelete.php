<?php 
    ...
    if($_GET) {
        ...
        // echo $submittedData['id'];
        $deleteGroup = query('DELETE from events WHERE id = :id', array('id' => $submittedData['id']));

        if($deleteGroup) {
            header('Location: eventsList.php?delete_success');
        }
