<?php
 ...
 ?>
    ...
    <main id="main-content">
        ...
        <h1><a href="galaManagements.php">Gala Management</a> / Heats/Final List</h1>
        <a href="heatFinalAdd.php"><button class="add">Add</button></a>
        <br>
        <br>
        ...
        <?php 
            ...
            $limit=10;
            $results = getData('SELECT * FROM heat_final ORDER BY id', $limit, $page);
            ...
            <?php 
             ...
             ?>
                <tr>
                    ...
                    <td>
                    <a href="heatFinalEdit.php?id=<?= $result->id; ?>"><button class="edit">Edit</button></a> 
                    <a href="#<?= $result->id; ?>"><button class="delete">Delete</button></a>

                    <div class="modal" id="<?= $result->id; ?>">
                        <div class="modal-content">
                            <p>Delete <b><?= $result->description; ?></b> ?</p><br>
                            <a href="#cancel"><button class="info">Cancel</button></a>                            
                            <a href="heatFinalDelete.php?id=<?= $result->id; ?>"><button class="delete">Delete</button></a>   
                        </div>
                    </div>
                </td>
                </tr>                
