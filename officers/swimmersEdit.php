    ...
    <main id="main-content">
        ...
        ?>
                    ...
                    <form method="post" action="swimmersEdit.php?id=<?= $queryOne[0]->id ?>">
                        ...
                        <label>
                            First Name
                            <input required aria-required="true" type="text" name="fname" placeholder="Please type fname..." maxlength="50" value="<?= (isset($queryOne[0]->fname)) ? $queryOne[0]->fname : output(@$fname) ?>">
                            <?php output(@$validationMsg['fname']) ?>
                        </label><br><br>
                        <label>
                            Last Name
                            <input required aria-required="true" type="text" name="lname" placeholder="Please type lname..." maxlength="50" value="<?= (isset($queryOne[0]->lname)) ? $queryOne[0]->lname : output(@$lname) ?>">
                            <?php output(@$validationMsg['lname']) ?>
                        </label><br><br>
                        <label>
                            Date of Birth
                            <input type="date" name="dob" required aria-required="true" maxlength="20" value="<?= (isset($queryOne[0]->dob)) ? $queryOne[0]->dob : output(@$dob) ?>"/>
                            <?php output(@$validationMsg['dob']) ?>
                        </label><br><br>
                        <label>
                             Email:
                            <input required style="width: 200px;" list='email' type="text" name="email" value="<?= (isset($queryOne[0]->email)) ? $queryOne[0]->email : output(@$email)?>">
