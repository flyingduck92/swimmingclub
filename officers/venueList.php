<?php
 ...
 ?>
    ...
    <main id="main-content">
        ...
        <h1><a href="galaManagements.php">Gala Management</a> / Venue List</h1>
        <a href="venueAdd.php"><button class="add">Add</button></a>
        <br>
        <br>
        ...
        <?php
            ...
            $limit=10;
            $results = getData('SELECT * FROM venue ORDER BY id', $limit, $page);
            ...
            <?php
             ...
             ?>
                <tr>
                    ...
                    <td><?= $result->name; ?></td>
                    <td>
                    <a href="venueEdit.php?id=<?= $result->id; ?>"><button class="edit">Edit</button></a>
                    ...
                    <div class="modal" id="<?= $result->id; ?>">
                        <div class="modal-content">
                            ...
                            <a href="venueDelete.php?id=<?= $result->id; ?>"><button class="delete">Delete</button></a>
                        </div>
                    </div>
                </td>
                </tr>
